...
def menu():
    ...
    # Função para contar bombas nas proximidades de uma célula
    def proximidade():
        co = col
        cont = 0
        co[0] -= 1
    ...
    # Função para obter o tempo atual em centésimos de segundo
    def tempo():
    ...
    # Inicializa o layout do campo de jogo
    for i in range(10):
        layout2.append([])
    ...
    # Loop para leitura de eventos da janela do jogo
    if condicao:
        while True:
